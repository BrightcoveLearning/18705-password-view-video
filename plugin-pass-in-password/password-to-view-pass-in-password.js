videojs.registerPlugin('passwordToView', function(pluginOptions) {
  ...
  newElement.innerHTML = '<div><img class="bcls-image" src="file:///Users/julissagirardi/Documents/GitHub/player-en/Asset%2014password%20lock.png"><br><input class="theForm" type="password" id="passwordInputID"><br><input id="formButtonID" class="theForm" type="submit" value="Sign In"></div>';
